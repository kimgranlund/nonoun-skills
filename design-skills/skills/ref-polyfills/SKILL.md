---
name: ref-polyfills
description: Use when working with polyfills, ponyfills, transpilation, build-tool target lowering, browser-compatibility shims, or known browser bugs at a modern support baseline (Chromium 125+, Safari 17.4+, Firefox 129+). Opinionated and modern-first — most things you used to polyfill are native now. Triggers on "polyfill", "ponyfill", "shim", "browserslist", "babel", "swc", "esbuild", "lightningcss", "core-js", "target lowering", "transpile", "@supports", "feature detection", or any "do I need to polyfill X for browser Y" question. Also triggers on known browser-quirk questions ("Safari oklch bug", "popover light-dismiss iOS", "anchor positioning Firefox", "polyfill.io safe?"). Peers with ui-build-components, analyze-css, ref-color, ref-dashboard.
---
