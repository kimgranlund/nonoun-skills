 ...
 */
export function simulationMatrix(type, severity = 1.0) {
 ...
 */
export function simulate(rgb, type, severity = 1.0) {
    const M = simulationMatrix(type, severity);
    const [r, g, b] = mulMat3Vec3(M, rgb);
    return linearSRGB(r, g, b);
}
// ─── Convenience helpers ──────────────────────────────────────────────────────
export const simulateProtanopia = (rgb, severity = 1.0) => simulate(rgb, 'protanopia', severity);
export const simulateDeuteranopia = (rgb, severity = 1.0) => simulate(rgb, 'deuteranopia', severity);
export const simulateTritanopia = (rgb, severity = 1.0) => simulate(rgb, 'tritanopia', severity);
