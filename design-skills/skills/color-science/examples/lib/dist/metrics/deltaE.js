 ...
 */
export function deltaE94(a, b, textiles = false) {
    const [L1, a1, b1] = a;
    const [L2, a2, b2] = b;
...
export const testCases = [
    ...
    // Sharma et al. (2005), Table 1 — selected CIEDE2000 test pairs:
    {
        ...
        fn: () => deltaE2000(cielab_D65(50, 2.6772, -79.7751), cielab_D65(50, 0.0, -82.7485)),
        expected: 2.0425,
        tolerance: 5e-4,
    ...
    },
    {
        ...
        fn: () => deltaE2000(cielab_D65(50, 3.1571, -77.2803), cielab_D65(50, 0.0, -82.7485)),
        expected: 2.8615,
        tolerance: 5e-4,
