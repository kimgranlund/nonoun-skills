...
export const passesAA = (a, b) => wcagContrast(a, b) >= 4.5;
/** True iff the pair clears WCAG AA for large text (≥3.0:1). */
export const passesAALarge = (a, b) => wcagContrast(a, b) >= 3.0;
/** True iff the pair clears WCAG AAA for normal text (≥7.0:1). */
export const passesAAA = (a, b) => wcagContrast(a, b) >= 7.0;
// ─── Test cases ───────────────────────────────────────────────────────────────
