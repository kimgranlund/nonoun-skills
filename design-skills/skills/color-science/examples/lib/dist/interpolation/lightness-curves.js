...
export function linearRamp(t, lMin = 0, lMax = 1) {
 ...
 * - gamma = 1: linear
 */
export function gammaRamp(t, gamma, lMin = 0, lMax = 1) {
 ...
 */
export function perceptualRamp(t, lMin = 0, lMax = 1) {
    return lMin + t * (lMax - lMin);
}
/**
 ...
 */
export function smoothstepRamp(t, lMin = 0, lMax = 1) {
    const s = t * t * (3 - 2 * t);
 ...
 */
export const TAILWIND_V4_L_STOPS = [
    0.985, // 50
    0.967, // 100
    0.922, // 200
    0.870, // 300
 ...
 */
export function tailwindV4LAtStep(step) {
    const stepMap = {
