 ...
 */
export function lerpHue(h1, h2, t, path = 'shorter') {
    h1 = wrapHueDeg(h1);
    h2 = wrapHueDeg(h2);
    const diff = h2 - h1;
    let effDiff;
...
export function lerpTuple(a, b, t) {
    return [
        a[0] + (b[0] - a[0]) * t,
        a[1] + (b[1] - a[1]) * t,
        a[2] + (b[2] - a[2]) * t,
...
export function lerpCielch(a, b, t, huePath = 'shorter') {
    return [
        a[0] + (b[0] - a[0]) * t,
        a[1] + (b[1] - a[1]) * t,
        lerpHue(a[2], b[2], t, huePath),
 ...
 */
export function mixVia(a, b, t, sourceSpace, viaSpace) {
