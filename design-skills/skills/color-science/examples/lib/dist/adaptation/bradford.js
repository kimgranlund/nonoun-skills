...
export const D65 = [0.9504559270516716, 1.0, 1.0890577507598784];
/** D50 — ICC Profile Connection Space (ICC.1:2010, Annex D). */
export const D50 = [0.9642956764295677, 1.0, 0.8251046025104603];
/** A — incandescent tungsten (~2856 K). */
export const A = [1.0985, 1.0, 0.35585];
/** F2 — cool white fluorescent. */
export const F2 = [0.99186, 1.0, 0.67393];
