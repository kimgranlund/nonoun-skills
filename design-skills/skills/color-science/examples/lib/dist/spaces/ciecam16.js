...
import { mulMat3Vec3, ciecam16_JMh, xyz, wrapHueDeg } from '../types.js';
...
export function fromXYZ(c, pre = precompute(DEFAULT_VC)) {
...
export function toXYZ(jmh, pre = precompute(DEFAULT_VC)) {
    const [J, M, hDeg] = jmh;
