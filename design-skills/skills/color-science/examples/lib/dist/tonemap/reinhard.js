 ...
 */
export function reinhardSimple(x) {
    return x / (1 + x);
}
/**
...
const Y_WEIGHTS = [0.2126390059, 0.7151686788, 0.0721923154];
 ...
 */
export function applyLuminancePreserving(rgb, whitePoint = 4.0) {
