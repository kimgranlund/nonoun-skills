---
name: plan-knowledge
description: "Use this skill whenever a user wants to set up a Claude Project knowledge base, create foundational knowledge documents, structure project context files, or establish a knowledge-first workflow. Triggers: setting up a Claude Project, creating project docs/context files, building a knowledge base for Claude, onboarding Claude to a codebase/domain, making a CLAUDE.md or README, asking how to make Claude 'know' their project, reshaping or migrating existing docs into a knowledge base. Example phrases: 'help me organize what Claude needs to know', 'set up a Claude project', 'fix my knowledge base', 'audit my project docs', 'make Claude useful for [domain]'. Do NOT trigger for general project management, task planning, or non-Claude project organization."
---
